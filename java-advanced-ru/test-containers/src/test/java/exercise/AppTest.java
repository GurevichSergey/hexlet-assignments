...
public class AppTest {
    ...
    void testGetPerson() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).isEqualTo("{\"id\":1,\"firstName\":\"John\",\"lastName\":\"Smith\"}");
    }
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse responseUpdate = mockMvc
                .perform(
                        (patch("/people/1"))
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\": \"Lena\", \"lastName\": \"Golovach\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Lena", "Golovach");
    }
}
